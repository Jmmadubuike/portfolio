...
export const technologyDomains = [
  ...
  "Platform Strategy",
  "Automation and Accountability Systems",
  "Emerging Market Infrastructure",
];

export const philosophyPrinciples = [
  "Technology must solve measurable problems",
  "African systems require locally adaptive infrastructure",
  "Visibility creates accountability",
  "Automation increases institutional efficiency",
  "Scalable digital systems can transform governance, education, healthcare, logistics, and commerce",
];

export const convergenceDomains = [
  "Media",
  "Enterprise Systems",
...
export const visionQuote =
  "The future of Africa will not be built by consumers of technology, but by architects of systems that solve African problems at scale.";
